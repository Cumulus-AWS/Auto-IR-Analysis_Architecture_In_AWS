...
GuardDuty는 EC2에서 발생한 위협 뿐만 아니라 S3,Iam등 다양한 AWS서비스에서 위협을 탐지 해내기에 EC2에서 발생하는 위협은 아티팩트 채증이 불필요하다고 생각하여, 아티팩트 채증 스텝펑션은 돌리지 않되, 위협수준이 높으므로 디스코드로 알림만 보내도록 하였다.
<p align="center">
