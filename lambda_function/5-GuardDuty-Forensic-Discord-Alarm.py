...
# Lambda function to send a notification to Discord when forensic automation is executed
...
def lambda_handler(event, context):
    ...
    # Extract instance ID and finding ID from the CloudWatch event
    ...
    data["embeds"] = [
        {
            "title": f"**Automation Forensic is executed, in {InstanceID}**",
            "description": (
                "\n\n"
