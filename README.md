...
해킹 공격에 의한 침해사고 탐지 후 클라우드 환경에서의 증거 수집이 이루어져야 한다.
이 때 대상 서버에서 휘발성 데이터(memory 등)을 자동 수집하고, 추가 침해사고 분석을 위한 Disk/EC2(서버)스냅샷 등을 자동화하는 아키텍처를 설계하는 것
...
1. VPC
   ...
   <a href="https://github.com/Cumulus-AWS/Auto-IR-Analysis_Architecture_In_AWS/blob/main/Image/VPC.png">
    <img src="Image/VPC.png" width="200" height="100">
  </a>
1. EC2
    * ~~<br />
1. S3
